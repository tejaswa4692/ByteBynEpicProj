...
export const moderateRepo = (url, owner, name, isMod) => fetch(`${API}/repos/moderate`, { method: 'POST', headers: auth(), body: JSON.stringify({ repo_url: url, owner, repo_name: name, is_moderated: isMod }) }).then(json)
